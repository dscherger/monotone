             ...
             options::opts::none)
{
  ...
  for (args_vector::const_iterator i = args.begin(); i != args.end(); ++i)
    {
      revision_id rid((*i)());
      E(!db.sentinel_exists(rid), F("missing revision %s") % rid);
             ...
             options::opts::none)
{
  ...
  for (args_vector::const_iterator i = args.begin(); i != args.end(); ++i)
    {
      revision_id rid((*i)());
      N(db.revision_or_sentinel_exists(rid), F("No such revision %s") % rid);
      revs.insert(rid);
    }
             ...
             options::opts::none)
{
  ...
  for (++i; i != args.end(); ++i)
    {
      revision_id b((*i)());
      E(!db.sentinel_exists(b), F("missing revision %s") % b);
             ...
             options::opts::none)
{
  ...
  if (args.size() == 0)
  ...
  else
    {
      ...
      N(db.revision_or_sentinel_exists(rid),
             ...
             options::opts::none)
{
  ...
  E(!db.sentinel_exists(r_id), F("missing revision %s") % r_id);
