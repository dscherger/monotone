...
public:
  ...
  bool hook_get_revision_cert_trust(std::set<key_name> const & signers,
                                   id const & hash,
  ...
  bool hook_get_manifest_cert_trust(std::set<key_name> const & signers,
                                    ...
                                    cert_name const & name,
                                    cert_value const & val);
  bool hook_accept_testresult_change(std::map<key_name, bool> const & old_results,
                                     std::map<key_name, bool> const & new_results);
  ...
  bool hook_get_netsync_read_permitted(std::string const & branch);
  bool hook_get_netsync_write_permitted(key_name const & identity);
  ...
  bool hook_note_netsync_revision_sent(revision_id const & new_id,
                                       ...
                                       cert_value> > > const & certs,
                                       size_t session_id);
  bool hook_note_netsync_pubkey_received(key_name const & kid,
                                         size_t session_id);
  bool hook_note_netsync_pubkey_sent(key_name const & kid,
                                     size_t session_id);
