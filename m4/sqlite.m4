...
AC_SEARCH_LIBS([fullfsync], [rt],
 [SQLITE_CPPFLAGS="$SQLITE_CPPFLAGS -DHAVE_FULLFSYNC=1"])

AC_SEARCH_LIBS([usleep], [rt],
 [SQLITE_CPPFLAGS="$SQLITE_CPPFLAGS -DHAVE_USLEEP=1"])

AC_SEARCH_LIBS([locatime_r], [],
 [SQLITE_CPPFLAGS="$SQLITE_CPPFLAGS -DHAVE_LOCALTIME_R=1"])

AC_SEARCH_LIBS([gmtime_r], [],
 [SQLITE_CPPFLAGS="$SQLITE_CPPFLAGS -DHAVE_GMTIME_R=1"])
