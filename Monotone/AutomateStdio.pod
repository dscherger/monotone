...
=item B<$mtn = Monotone::AutomateStdio-E<gt>new($db[, \@options])>
...
returned by the $mtn-E<gt>closedown() method. If there is a match then there is
a problem, otherwise, as far as this class is concerned, there is nothing to
worry about.
