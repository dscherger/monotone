...
check(mtn_no_ws("setup", "--branch=testbranch", "setup_default"), 0, false, false)
...
check(mtn_no_ws("--rcfile=off.lua", "setup", "--branch=testbranch", "setup_off"), 0, false, false)
...
check(mtn_no_ws("--rcfile=on.lua", "setup", "--branch=testbranch", "setup_on"), 0, false, false)
