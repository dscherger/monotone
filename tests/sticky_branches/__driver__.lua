...
check(indir("codir", mtn("branch", "otherbranch")), 0, false, false)
check(indir("codir", mtn("commit", "--message=foo")), 0, false, false)
...
check(indir("third1", mtn("branch", "third")), 0, false, false)
check(indir("third1", mtn("commit", "--message=foo")), 0, false, false)
check(mtn("co", "--branch=testbranch", "third2"), 0, false, false)
writefile("third2/b", "2b")
check(indir("third2", mtn("add", "b")), 0, false, false)
check(indir("third2", mtn("branch", "third")), 0, false, false)
check(indir("third2", mtn("commit", "--message=foo")), 0, false, false)
