...
-- The last "add" changed _MTN/options database to subdir/test.db
check(mtn("--db=test.db", "add", "subdir/test.db"), 0, false, false)
check(mtn("--db=test.db", "ls", "known"), 0, true, false)
