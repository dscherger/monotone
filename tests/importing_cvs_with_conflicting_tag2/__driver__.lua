...
xfail(mtn("--branch=testbranch", "cvs_import", "cvs-repository"), 0, false, false)
check(mtn("co", "-r", "t:NASTY_TAG", "."))

check(mtn("list", "known"), 0, true)
check(samelines("stdout", {"fileA", "fileB", "fileC", "fileD", "fileE", "fileF"}))
