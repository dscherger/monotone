...
check(mtn("commit", "--date=1999-01-01T12:00:00", "--message-file=blah_blah.txt"), 0, false, false)
rev = base_revision()
...
check(mtn("commit", "--date=2000-01-01T12:00:00", "--message-file=blah_blah.txt"), 0, false, false)
...
check(mtn("commit", "--date=2001-01-01T12:00:00", "--message-file=blah_blah.txt"), 0, false, false)
...
check(mtn("commit", "--date=2003-01-01T12:00:00", "--message-file=blah_blah.txt"), 0, false, false)
