...
-- _MTN/options has database test2.db; we need to check test.db
check(mtn("--db=test.db", "list", "epochs"), 0, true, false)
...
check(mtn("--db=test.db", "automate", "get_revision", revs[1]), 1, false, false)
