...
echo "version 1b of test file foo" > test/foo
cvs commit -m "commit 1b in between" test/foo

echo "version 1c of test file foo" > test/foo
cvs commit -m "commit 1c in between" test/foo

echo "version 1d of test file foo" > test/foo
cvs commit -m "commit 1d in between" test/foo
