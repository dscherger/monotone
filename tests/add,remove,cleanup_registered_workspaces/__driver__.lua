...
check(mtn("register-workspace"), 0, false, false)
check(mtn("ls", "vars"), 0, true, false)
check(qgrep("database: known-workspaces .+/"..testname, "stdout"))

check(mtn("register-workspace", "foo"), 0, false, false)
check(mtn("ls", "vars"), 0, true, false)
check(qgrep("database: known-workspaces .+/"..testname, "stdout"))
...
check(mtn("register-workspace", "bar"), 0, false, false)
check(mtn("ls", "vars"), 0, true, false)
check(qgrep(testname .. "/bar", "stdout"))

check(mtn("register-workspace", "baz"), 0, false, false)

check(mtn("unregister-workspace", "foo"), 0, false, false)
check(mtn("ls", "vars"), 0, true, false)
check(not qgrep(testname .. "/foo", "stdout"))

check(mtn("cleanup-workspace-list"), 0, false, false)
check(mtn("ls", "vars"), 0, true, false)
