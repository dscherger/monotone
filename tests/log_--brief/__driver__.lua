...
check(mtn("commit", "--date", "2005-08-16T03:16:00", "-m", "foo"), 0, false, false)
R0=base_revision()
...
check(mtn("branch", "otherbranch"), 0, false, false)
check(mtn("commit", "--date", "2005-08-16T03:16:05", "-m", "foo"), 0, false, false)
R2=base_revision()
