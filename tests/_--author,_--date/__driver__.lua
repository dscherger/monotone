...
check(mtn("commit", "--author=the_author", "--date=1999-12-31T12:00:00", "--message=foo"), 0, false, false)
rev = base_revision()
...
check(mtn("commit", "--date=1999-12-31T12:00foo", "--message=foo"), 1, false, false)
