...
UNIT_TEST(restrictions, simple_include)
{
  ...
  node_restriction nmask(includes, excludes, -1, roster, work);
  ...
  path_restriction pmask(includes, excludes, -1, work);
...
UNIT_TEST(restrictions, invalid_roster_paths)
{
  ...
  workspace work;
  UNIT_TEST_CHECK_THROW(node_restriction(includes, excludes, -1, roster, work), 
                    informative_failure);
}
...
UNIT_TEST(restrictions, invalid_workspace_paths)
{
  ...
  workspace work;
  UNIT_TEST_CHECK_THROW(path_restriction(includes, excludes, -1, work),
                    informative_failure);
}
...
UNIT_TEST(restrictions, include_depth_0)
{
  ...
  node_restriction nmask(includes, excludes, depth, roster, work);
  ...
  path_restriction pmask(includes, excludes, depth, work);
