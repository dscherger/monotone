...
version (currently 0.42). If you happen to be using a newer version of Monotone
...
Sometimes you may make a complex request to the mtn subprocess that takes a
number of seconds to process. Consequently this class will take that amount of
time, plus a very small processing overhead, to return. Whilst one can get
